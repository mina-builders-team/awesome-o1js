...
- [Anon Aadhaar in o1js](https://github.com/mina-builders-team/anon-aadhaar-o1js/) - An implementation of the Anon Aadhaar protocol enabling Aadhaar users to generate proofs about their private identity data.
